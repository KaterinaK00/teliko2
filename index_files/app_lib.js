...
function studentGradesDatatable(selector, data) {
    return $(selector).createDataTable({
        ...
        columns: [
            ...
            {data: "semesterId.title", title: IlyLocales.entity.all.semesterId, visible: false,
                render: function (data, type, row) {
                    return (typeof data !== "undefined" && data !== null && data.semesterId !== null) ? row.semesterId.title : '-';
                }
            },
            {data: "semesterId.sortOrder", title: IlyLocales.entity.all.semesterId, visible: false,
                render: function (data, type, row) {
